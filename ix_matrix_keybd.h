...
static unsigned int imapx200_matrix_keys[] = {
	...
	KEY(5, 2, KEY_F9), KEY(5, 3, 12),
	KEY(5, 4, KEY_0), KEY(5, 5, KEY_M),
	KEY(5, 6, KEY_P), KEY(5, 7, 39),

	KEY(6, 0, 41), KEY(6, 1, KEY_H),
        KEY(6 ,2, 1), KEY(6, 3, KEY_2),
	KEY(6, 4, KEY_1), KEY(6, 5, KEY_C),
	KEY(6, 6, KEY_W), KEY(6, 7, KEY_D),
	KEY(7, 0, KEY_KPDOT), KEY(7, 1, 127),

	KEY(7, 2, KEY_PAUSE), KEY(7, 3, KEY_UP),
	KEY(7, 4, KEY_8), KEY(7, 5, KEY_SPACE),
	KEY(7, 6, 53), KEY(7, 7, KEY_LEFT),
	...
	KEY(14, 2, KEY_F11), KEY(14, 3, 26),
	KEY(14, 4, 13), KEY(14, 5, KEY_FN),
	KEY(14, 6, 27), KEY(14, 7, 40),
